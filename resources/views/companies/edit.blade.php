        ...
        <div class="row col-md-12  col-lg-12  col-sm-12" style="background: #fff; margin: 10px;">
            ...
            <form method="post" action="{{route('companies.update',[$company->id])}}">
                ...
                <div class="form-group">
                    ...
                    <textarea name="description" id="company-content"  style="resize: vertical"  rows="5" spellcheck="false" placeholder="Enter Description" class="form-control autosize-target text-left">{{$company->description}}</textarea>
                </div>
